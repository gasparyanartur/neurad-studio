...
if __name__ == "__main__":
    ...
    parser.add_argument("--config_path", "-c", type=Path, default="configs/diffusion_model_configs.yml")
    parser.add_argument("--crop_size", help="crop size of images (before resize) [int, int]", nargs=2, default=(1024, 1024))
    parser.add_argument("--resize_size", help="downsampling size of input images (after crop) (int, int)", nargs=2, default=(512, 512))
    ...
    output_img = output["rgb"][0].detach().cpu()
